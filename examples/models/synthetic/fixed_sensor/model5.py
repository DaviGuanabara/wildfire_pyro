...
class SpatialRectifiedRegressor(nn.Module):
    def __init__(self, hidden=32, features=4, prob=0.5):
        super(SpatialRectifiedRegressor, self).__init__()
        ...
        self.activation1_before_aggr = nn.ReLU() #nn.PReLU() #LeakyReLU() #nn.Tanh() #nn.ReLU()
        ...
        self.activation12_before_aggr = nn.ReLU() #nn.PReLU() #LeakyReLU() #nn.Tanh() #nn.ReLU()
        ...
        self.activation2_before_aggr = nn.ReLU() #nn.PReLU() #LeakyReLU() #nn.Tanh()

        ##############

        self.linear1_attn = nn.Linear(self.features, hidden, bias=False)
        self.bn1_attn = nn.BatchNorm1d(num_features=hidden)
        self.activation1_attn = nn.ReLU() #nn.PReLU() #LeakyReLU() #nn.Tanh() #nn.ReLU()
        ...
        self.activation12_attn = nn.ReLU() #nn.PReLU() #LeakyReLU() #nn.Tanh() #nn.ReLU()
        ...
        self.activation1_after_aggr = nn.ReLU() #nn.PReLU() #LeakyReLU() #nn.Tanh() #nn.ReLU()

        self.dropout12 = nn.Dropout(p=prob)
        self.linear12_after_aggr = nn.Linear(hidden, hidden, bias=False)
        self.bn12 = nn.BatchNorm1d(num_features=hidden)
        self.activation12_after_aggr = nn.ReLU() #nn.PReLU() #LeakyReLU() #nn.Tanh() #nn.ReLU()
        ...
        self.activation2_after_aggr = nn.ReLU() #nn.PReLU() #LeakyReLU() #nn.Tanh()
