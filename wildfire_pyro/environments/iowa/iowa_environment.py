...
from wildfire_pyro.environments.iowa.adaptative_environment import AdaptativeEnvironment
...
class IowaEnvironment(AdaptativeEnvironment):
    def __init__(self, data_path, verbose: bool = False):
        ...
        super().__init__(data_path=data_path, metadata=metadata, params=params, verbose=verbose)
